...
// ============================================
// ENS Registry - Exact ENS Architecture
// DEPLOY ORDER: 1 of 7
// Constructor: No parameters
// 
// IMPORTANT: Select "TNSRegistry" from the dropdown
// ============================================
...
/**
 * @dev The TNS registry contract - exact ENS architecture.
 */
contract TNSRegistry is ITNS {
    ...
    /**
     * @dev Enable or disable approval for a third party ("operator") to manage all of `msg.sender`'s TNS records.
