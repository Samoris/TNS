...
contract TNSRegistry {
    ...
    uint256 public constant PRICE_3_CHARS = 2 ether;
    uint256 public constant PRICE_4_CHARS = 0.1 ether;
    uint256 public constant PRICE_5_PLUS = 0.02 ether;
    ...
    function calculateCost(string calldata domain, uint256 duration) public pure returns (uint256) {
    ...
    function register(string calldata domain, uint256 duration) external payable validDomain(domain) {
        require(duration > 0 && duration <= 10, "Invalid duration");
