...
export interface BaseRegistrarInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "transferPeriodEnds",
    values?: undefined
  ): string;
...
export interface BaseRegistrar extends BaseContract {
  ...
  acceptRegistrarTransfer: TypedContractMethod<
    [label: BytesLike, deed: AddressLike, arg2: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  previousRegistrar: TypedContractMethod<[], [string], "view">;

  reclaim: TypedContractMethod<[id: BigNumberish], [void], "nonpayable">;
  ...
  transferPeriodEnds: TypedContractMethod<[], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "previousRegistrar"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "transferPeriodEnds"
  ): TypedContractMethod<[], [bigint], "view">;
