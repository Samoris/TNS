...
export namespace ControllerChangedEvent {
  export type InputTuple = [controller: AddressLike, enabled: boolean];
  export type OutputTuple = [controller: string, enabled: boolean];
...
export namespace DefaultResolverChangedEvent {
...
export namespace ReverseClaimedEvent {
  export type InputTuple = [addr: AddressLike, node: BytesLike];
  export type OutputTuple = [addr: string, node: string];
  export interface OutputObject {
    addr: string;
    node: string;
  }
...
export interface ReverseRegistrar extends BaseContract {
  ...
  >;
  getEvent(
    key: "DefaultResolverChanged"
  ): TypedContractEvent<
    DefaultResolverChangedEvent.InputTuple,
    DefaultResolverChangedEvent.OutputTuple,
    DefaultResolverChangedEvent.OutputObject
  >;
  getEvent(
  ...
  getEvent(
    ...
    ReverseClaimedEvent.InputTuple,
    ReverseClaimedEvent.OutputTuple,
    ReverseClaimedEvent.OutputObject
  >;
  ...
  filters: {
    ...
    "DefaultResolverChanged(address)": TypedContractEvent<
      DefaultResolverChangedEvent.InputTuple,
      DefaultResolverChangedEvent.OutputTuple,
      DefaultResolverChangedEvent.OutputObject
    >;
    DefaultResolverChanged: TypedContractEvent<
      DefaultResolverChangedEvent.InputTuple,
      DefaultResolverChangedEvent.OutputTuple,
      DefaultResolverChangedEvent.OutputObject
    >;
    ...
    "ReverseClaimed(address,bytes32)": TypedContractEvent<
      ReverseClaimedEvent.InputTuple,
      ReverseClaimedEvent.OutputTuple,
      ReverseClaimedEvent.OutputObject
    >;
    ReverseClaimed: TypedContractEvent<
      ReverseClaimedEvent.InputTuple,
      ReverseClaimedEvent.OutputTuple,
      ReverseClaimedEvent.OutputObject
    >;
