...
export interface TNSRegistryInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "isApprovedForAll"
      | "owner"
...
export interface TNSRegistry extends BaseContract {
  connect(runner?: ContractRunner | null): TNSRegistry;
  waitForDeployment(): Promise<this>;

  interface: TNSRegistryInterface;
